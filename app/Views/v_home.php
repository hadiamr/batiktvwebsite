        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 mb-5 py-3">
                    <a target="_blank" href="https://pasirkencana.pekalongankota.go.id/"><img class="img-fluid rounded iklan" src="../home/assets/img/iklan/TWL.webp" alt="Banner Iklan"></a>
                </div>
            </div>
        </div>
    </div>
        ...
        <section class="customer-logos slider">
            <?php foreach ($mitra as $row) : ?>
                <div class="slide mx-3 mt-2">
                    <?php
                    if (!empty($row->logo)) : ?>
                        <img src="<?= base_url('../admin/img/mitra/' . $row->logo) ?>" width="100" alt="Logo <?= $row->nama ?>" title="Logo <?= $row->nama ?>" labelForId="Logo <?= $row->nama ?>" aria-label="Logo <?= $row->nama ?>">
                    <?php endif; ?>
                </div>
            <?php endforeach; ?>
        </section>
